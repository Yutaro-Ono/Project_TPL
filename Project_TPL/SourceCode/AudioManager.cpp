...
AudioSE * AudioManager::GetSound(const std::string & in_fileName)
{
	AudioSE* sound = nullptr;
...
AudioBGM * AudioManager::GetMusic(const std::string & in_fileName)
{
	AudioBGM* music = nullptr;
...
{
	AudioBGM::FadeOutMusic(in_fadeTime);
}
